    ...
    <div>
      <header className="flex items-center justify-between p-3 bg-white mb-3 rounded-xl ">
        <div>
          <button
            onClick={handleToday}
            className="text-xs border border-borderColor rounded p-1 font-semibold"
          >
            Today
          </button>
        </div>
        ...
        <div className="flex space-x-2">
          <button
            ...
            className={`text-xs border border-dashboard-border p-1 font-semibold rounded-md ${view === "viewMonth" ? "bg-[#4B8EC8] text-white" : ""}`}
          >
            Monthly
          </button>
          <button
            onClick={() => setView("weekly")}
            className={`text-xs border border-dashboard-border p-1 rounded-md font-semibold ${view === "weekly" ? "bg-blue-100" : ""}`}
          >
            Weekly
          </button>
        </div>

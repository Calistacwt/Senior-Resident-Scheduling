...
import { formatDate, formattedDate } from "@/utils/formatter";
...
const Card: React.FC<CardProps> = ({ scheduleData }) => {
  return (
    <div className="bg-background rounded-lg mt-10 p-3 border border-sidebar-border ml-4">
      <div className="">
        <img
      ...
      <div className="mt-3 max-h-96 overflow-y-auto">
        {scheduleData.map((schedule, index) => (
          <div key={index} className="flex space-x-6 p-3 ">
            ...
            <div className="flex flex-col space-y-7  ">
              <div className="flex justify-between items-center space-x-4  w-56">
                <div
